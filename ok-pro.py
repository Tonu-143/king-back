...
def banner():
	...
	sol().print(cik2)
	ban='''
•   AUTHOR : MEHEDI HASAN TONU WHATSAPP : +8801759916221   •
•   ____  _____      _______ ______ _____  __  __ _    ___   __
 |  _ \|  __ \    |__   __|  ____|  __ \|  \/  | |  | \ \ / /
 | |_) | |  | |______| |  | |__  | |__) | \  / | |  | |\ V / 
 |  _ <| |  | |______| |  |  __| |  _  /| |\/| | |  | | > <  
 | |_) | |__| |      | |  | |____| | \ \| |  | | |__| |/ . \ 
 |____/|_____/       |_|  |______|_|  \_\_|  |_|\____//_/ \_\VERSION 4.0.4   •
•                                               •
•   GITHUB : TONU-143  •'''
...
if __name__=='__main__':
	try:os.mkdir('/sdcard/TONU-DATA/CP')
	except:pass
	try:os.mkdir('/sdcard/TONU-DATA/OK')
	except:pass
	try:os.mkdir('/sdcard/TONU-DATA/DUMP')
	except:pass
	login()
